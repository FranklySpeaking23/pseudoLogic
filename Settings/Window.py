...
LOGS = True #show logs that the program makes
...
SIDEBAR_WHILE_STATEMENT = True #True: there is a sidebar next to the while-statement, False: there is no sidebar next to the statement
...
SIDEBAR_IF_STATEMENT = False #True: there is a sidebar next to the if-statement, False: there is no sidebar next to the statement
WIDTH_SIDEBAR_IF_STATEMENT = 15 #the width of the sidebar of an if-statement --> needs to be at least 1, can't be bigger that MARGIN_IF_STATEMENT_LEFT
