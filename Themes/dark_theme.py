...
#colors
FIELD = C("#333333") #default input field
IF_STATEMENT = C("#333333") #if-statement
IF_THAN_LINE = C("#333333") #the line between the if-than and if-statement fields
IF_ELSE_LINE = C("#333333") #the line between the if-than and if-statement fields
IF_THAN = C("#333333") #the "than" triangle of the if statement
IF_ELSE = C("#333333") #the "else" triangle of the if statement
SUB_IF_TRUE_STATEMENT = C("#333333") #every field inside of the if-statement
SUB_IF_FALSE_STATEMENT = C("#333333") #every field inside of the if-statement
WHILE_STATEMENT = C("#333333") #repeating-statement
SUB_WHILE_STATEMENT = C("#333333") #every field inside of the repeating-statement
FUNCTION = (50, 40, 45) #the color of a function field
SUB_FUNCTION = (50, 40, 45) #the color of a field inside a function
HOVER = C("#555555") #on mouse hover
SELECTED = (100, 100, 100) #when selected
TEXT = (255, 255, 255) #text
BACKGROUND = C("#111111") #background

#window
WIDTH = 900 #at least 300
HEIGHT = 500
FPS = 60 #frames per second
TITLE = "ustruct 2" #window title
